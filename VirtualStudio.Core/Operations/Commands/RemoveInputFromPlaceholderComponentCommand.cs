...
{
    public class RemoveInputFromPlaceholderComponentCommand : IVirtualStudioCommand<bool>
    {
        ...
        public RemoveInputFromPlaceholderComponentCommand(int componentId, int endpointId)
        {
